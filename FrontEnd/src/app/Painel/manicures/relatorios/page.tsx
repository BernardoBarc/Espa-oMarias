        ...
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-gray-400 font-medium">Relatórios Mensais</p>
            </div>
          </div>
            ...
            <div className="flex flex-col lg:flex-row items-center justify-between gap-6">
              <div className="text-center lg:text-left">
                <div className="flex items-center gap-3 mb-3 justify-center lg:justify-start">
                  ...
                  <h2 className="text-2xl font-bold text-blue-400">📅 Período do Relatório</h2>
                </div>
              ...
              <div className="bg-white/10 p-4 rounded-xl border border-white/20">
                <label className="block text-blue-300 font-semibold mb-2 text-sm">Mês/Ano</label>
                <input
                  type="month"
